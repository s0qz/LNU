...
class App:
    ...
    def start_draw(self):
        ...
        self.draw_text('PUSH SPACE BAR', self.screen, [width // 2, height // 2 - 50], text_size, (170, 132, 58), font, centered=True)
        self.draw_text('1 PLAYER ONLY', self.screen, [width // 2, height // 2 + 50], text_size, (44, 167, 198), font, centered=True)
    ...
    def playing_draw(self):
        ...
        self.draw_text('HIGH SCORE: 0', self.screen, [width // 2 + 60, 0], 18, white, font)
        self.player.draw()
        for enemy in self.enemies:
            enemy.draw()
        pygame.display.update()
